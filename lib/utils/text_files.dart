const tOnboardingTitle = [
  "Welcome to Mova",
  "Stream all the best movies",
  "Download to watch later",
];
const tOnboardingSubtitle = [
  "The best movie streaming app of the century to make your days great",
  "Watch the best in the very best quality",
  "Can't watch now, no worries, download and watch later",
];
const tOnboardingButtonText = [
  "Next",
  "Next",
  "Get Started",
];

const tLoginSignupText = 'Let\'s get you started';
const tLoginButtonText = [
